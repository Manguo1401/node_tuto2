...
describe('GET /todos/:id', () => {
    ...
    it('shouldreturn a 404 if a todo with id isnt found', (done) => {
...
describe('POST /users/login', () => {
    it('should return a logged in user and auth token', (done) => {
        request(app)
            .post('/users/login')
            .send({
                email: users[1].email,
